package com.fanfan.robot.local.db.base;
...
import com.fanfan.robot.local.db.DaoSession;
import com.fanfan.robot.local.db.interfaces.IDatabase;
import com.fanfan.robot.local.db.upgrade.MyOpenHelper;
...
public abstract class BaseManager<M, K> implements IDatabase<M, K> {
    ...
    public static final String DEFAULT_DATABASE_NAME = "local.db";
