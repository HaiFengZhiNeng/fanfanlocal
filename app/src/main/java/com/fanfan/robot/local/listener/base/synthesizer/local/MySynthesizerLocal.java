package com.fanfan.robot.local.listener.base.synthesizer.local;
...
import com.fanfan.robot.local.listener.base.synthesizer.TtsEventAdapter;
...
public class MySynthesizerLocal {
    ...
    private void buildTts() {
        ...
        mTts.setParameter(SpeechConstant.TTS_AUDIO_PATH, Constants.GRM_PATH + File.separator +"tts.wav");
